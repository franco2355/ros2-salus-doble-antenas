...
def _build_map_ekf(context):
    ...
    enable_global_imu_yaw = (
        LaunchConfiguration("enable_global_imu_yaw").perform(context).lower() == "true"
    )
...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("enable_global_imu_yaw", default_value="false"),
            DeclareLaunchArgument(
